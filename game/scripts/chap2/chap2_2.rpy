label chap2_2:
    ...
    scene bg_meiliv with pixellate
    mei "只是我应当知道，糖果的味道从来没变过。\n自然，改变的是其他东西。"

    xiang_speaking "哇哦，这糖好甜，谢谢你啊。"
    xiang_speaking "不过，为什么我每次想找梅雨问话，你都要岔开话题？"
    mei "……咦。"
    peng_speaking "你在说什么？只是巧合吧。"
    xiang_speaking "是吗？可能你自己没感觉，但真的很明显。"
    peng_speaking "……哦，既然你知道，那为什么还要继续问？你非要问这种问题吗？"
    mei "完了，感觉……气氛很不妙……"
    xiang_speaking "不是这个意思，我知道有些问题让人不想回答，我只是好奇为什么是你来拒绝。"
    peng_speaking "谁说的重要吗？你知道就是没有答案给你不就行了吗？"
    xiang_speaking "可能你觉得我是个怪人，但我也有良知。住在一起，我当然担心会不会无意影响她，只是这样才问。\n况且我问的是梅雨，她不是没有自理能力的小孩，她不想回答她自己会说。"
    peng_speaking "你……"
    ...
    mei "巨大的桌椅碰撞声后，向夏平稳地说完被打断的话。\n而突然拍桌站起的彭江丽，则是下意识快速扭头，对上了我的眼睛。"
    mei_speaking "啊……"
    mei "这四目相对十分突然，她的表情还停留在无比愤怒的状态，脸庞飞速地涨红。\n她的嘴唇无声地开合，眼睛颤抖地望着我，像是在恳求我做出什么回答。"
    mei "而我真的没能说出任何一句话。"
    peng_speaking "哈啊……这样啊，我明白了。\n抱歉，是我擅自做这样的事。"
    mei "不是……"
    peng_speaking "你……你们，你们继续聊吧。我先走了。"
    mei "不是这样的……"
    ...
    mei "彭江丽的笑容像在挤压我的心脏，逐渐演化成真实的疼痛。\n我弓起身体，用力捂住心口，张开的嘴没能闭上，而是开始大口喘息。"
    mei "怎么会变成这样……好痛……好痛……"

    xiang_speaking "喝点水吗？"
    mei_speaking "……\n谢谢。"
    mei_speaking "……"
    mei "缓慢地喝完水，我放下杯子，心情复杂地抬起头看她。但向夏只是平和地笑着，没有任何明显的情绪。\n这反倒让我难以开口，本就凌乱的心绪更加无法平静。"
    mei "的确，默认了彭江丽帮我岔开话题的是我，没有好好解释的是我，刚才，让彭江丽离开的人也是我……我实在，没有什么资格开口。\n可是，可是……"
    xiang_speaking "你想说什么吗？没有的话，我把这些碗收了就回去了？"
    mei_speaking "啊，嗯……"
    xiang_speaking "好。你的盒子刚刚掉地上了，我帮你放这咯。"
    mei_speaking "谢谢。\n……"
    mei "我捏紧药盒，突然被无名的情绪控制，毫无预兆地朝那个站起来的背影开口。"
    mei_speaking "之前是我，没有说话。你不要生彭江丽的气。我之后跟她说……"
    xiang_speaking "我没生气啊。这事冷静下来之后，说开就好了。"
    mei_speaking "……啊？你不是……"
    xiang_speaking "我没什么别的意思，只是想能好好说话。就像现在我知道你的态度，你不想说的事情我就不会问了。然后如果我哪里让你不舒服，你告诉我就好。"
    mei_speaking "哦……嗯。"
    mei "现在不应当产生这种心情，但……我真真切切松了口气。"
    mei "太好了，没有什么我没能解读出的暗示，她说话一如既往简单直接，太好了……"

    na "嘟，嘟……"
    mei "听筒里第三次传来未接电话的忙音，我下意识地再次重复拨号的动作，又在最后一个按键按下时匆匆止住。"
    mei "这样也没什么意义……彭江丽不想接电话，我再继续也只是骚扰而已。"
    mei "我有些困乏地拖着脚步上楼，放任自己的身体扑通一声倒在床上，用厚厚的被子把自己埋住。\n仿佛这样就能隔绝一切不顺心的事。"
    mei "以前，小时候……我和彭江丽从来没有吵过架。现在想来，说不定，只是她在让着我。"
    mei "明天，直接去找她吧。就算她要骂我……我还是想……"
    mei "我似乎在呢喃什么，但意识已经陷入了模糊。"

    na "呼——呼——呼——"
    na "哒，哒哒，哒哒……"
    mei "事情没能像昨天预想的那般发展。\n我坐在窗边，指关节来回敲打着窗台。不规律的敲击声响暴露了我内心的焦虑，但我无法控制。"
