label chap1_1:
    ...
    $ renpy.music.play(music.calming_piano, channel="music", loop=True, fadein=1.0)
    peng_speaking "是梅雨吗？你没事吧？！"
    mei_speaking "啊，啊，嗯……没事，抱歉，影响你了。"
    $ renpy.sound.set_volume(0.2, 0.5, channel="sound")
    $ renpy.sound.play(sound.buzz, channel="sound", loop=True)
    ...
    mei "挂掉的电话声音像宣判我死刑的钟声，终于缓缓降下来。{p}这样想是不对的，但是，在那一刻，我真的松了口气。"
    ...
    mei "现在是几点了……我不得不面对现实，从卷成一团的被子里爬出来。{p}真是的，我浪费了这么多时间，之后……嗯？之后……？"
    mei "不对，我已经不是在学校，治疗时间也早就结束了。\n没有要赶的课程，没有要做的检查。就算没浪费时间，也没有什么值得的事可以做。"
    mei "嗯，我现在就是这样毫无意义地浪费时间……"
    na "咕噜。"
    ...
    $ renpy.music.play(music.memory_1, channel="music", loop=True, fadein=1.0)
    pause
    ...
    mei "到底什么情况啊……我站在原地怔愣好一会才理清思绪。{p}我没有移动电话，只好小心地下楼，好在那个奇怪的人似乎不在客厅，不知道去哪了。"
    ...
    ye_speaking "应该没事的，她把她的证件放在我这里了。而且我有跟她说，她是住备用储藏室的，房间里有监控相机。况且，你房间又有锁，我每天也会过去看一次嘛。哦，对了，要不要给你配个手机？"
    ...
    $ renpy.sound.play(sound.cooking_1, channel="sound", fadein=0.5)
    mei "天气仍然不错，客厅的窗外是碧蓝的背景点缀着绿色枝条。轻微的滋滋声响逐渐从锅里冒出来，我无所事事，只需要等着菜热好，在此刻怪异地感觉到内心十分平静。"
    mei "作为一天的开始，这个场景也许还算不错。{p}当然，要是没有那两个人搞的事情就更好了……"
    stop sound

    scene bg_meicorridor with pixellate
    $ renpy.music.play(music.xiang_bath, channel="music")
    mei_speaking "嗯……？！"
    mei "我没想到，刚刚吃饭时才在心里吐槽过两个人，马上又遇到其中之一。{p}——这一回，我惊得连声音也发不出，只是赶紧转过头去，一眼也不想多看。"
    show q_x10 at cg_s with dissolve 
    unknown_speaking "啊，我还以为房子里是我室友呢，还没习惯过来，不好意思啊。"
    mei "她说着“不好意思”，但从语气到表情都完全没有感觉到"
    mei "方才轻瞟一眼，我看到一个全身赤裸的女人从角落的洗手间里走出来，只有手里的拿着的浴巾堪堪遮挡住胸口。{p}所以，她可以说是一丝不挂地站在我面前。"
    mei "什么情况啊……"
    mei_speaking "你衣服呢？"
    ...
    $ renpy.sound.play(sound.bird_chirping_1, channel="sound", loop=True, relative_volume=0.5)
    mei "小时候我经常寄住在彭江丽家，但之后就没有和我妈以外的人住过。现在也不像小时候那么简单，因而像现在这样，还是让我有些不习惯的感觉。"
    mei_speaking "啊，没有牙刷……"
    ...
    mei "到楼下，我又和一头卷发的女人撞见。本想就此忽略，但她忽然打出的巨大喷嚏让我愣了愣，下意识地停在原地，转头看她。"
    hide meiimg
    show meiimg shirt at char_left
    mei "……是之前洗澡的时候着凉了吧……{p}虽然现在已经是夏天的开始，但这里的早晚温差大，温度最低的时候一点也不像夏天。"
    mei "说起来，她这件衣服可能也不够厚……"
    return