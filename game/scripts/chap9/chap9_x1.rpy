label:
    ...
    xiang_speaking "没有没有，是这顿饭太好吃了，我都只顾着吃饭了嘛。"
    mei_speaking "嗯，是啊……"
    ...
    mei "至少，现在不是只有我一个人如坐针毡……我苦中作乐地用筷子戳着碗里的菜，假装此刻它们是如此有趣，以至于我没有抬头。"
    ...
    "就在几天前，我们还可以一起爬到天台，交换难以启齿的故事。现在，连互相对话好像也变得难以启齿。
    "
    mei "而且，她为什么要那样做……"
    mei "不对，不应该是这样的……\n也许我就不该在那个地方停留，这样就不会看到突如其来的场景，也不会扰乱自己的心跳，更不会现在不睡觉在这里反复纠结。"
