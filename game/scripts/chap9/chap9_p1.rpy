label chap9_p1:
    ...
    peng_speaking "你是不是太累了？对不起，我……"
    mei_speaking "就是有点困，没事啦。"
    peng_speaking "那，那你睡会吧！啊不过，你能在这睡着么？"
    mei_speaking "嗯……应该……"
    peng_speaking "我知道了！你躺在我腿上睡吧。"
    mei_speaking "啊？"
    mei "我呆住了，眼睁睁地看着她把自己的包压在角落，还冲我拍了拍自己的大腿。"
    mei_speaking "不不，不用了吧……"
    mei "莫名的，我十分慌张，甚至说话都有些结巴了。"
    peng_speaking "你坐着肯定睡不好呀。"
    mei_speaking "我我可以的。"
    ...
    peng_speaking "很开心啊，跟你出来玩，我要把这个收起来当作纪念！"
    ...
    peng_speaking "要是……"
    peng_speaking "时间在这停止就好了。"
    peng_speaking "这样我就不用再去考虑别的事情。"
    mei "是，有人在说话吗……我的耳朵像是被水膜罩住，只能隐约听见人类发出的声音，却听不真切。"
    peng_speaking "什么，都不用考虑……"
    peng_speaking "我只想跟你，待在一起。"
    mei "……有人在说我吗？不清楚……只是，我莫名地有些心慌，好似变得沉不住气。可眼皮仍然很重，抬不起来。"
    peng_speaking "啊……"
    mei "那人轻轻地发出一声长长的叹息。"
    peng_speaking "我太贪心了，但我还是想……"
    peng_speaking "想……跟梅雨一直在一起。"
    mei "……咦……"
    ...
    mei "目光落在脚下，我忽然意识到，这是第一天回到这里时走的路，现在的心境却完全不同。"
