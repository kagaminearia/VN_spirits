label chap9_p3:
    ...
    mei_speaking "别跑了！！"
    mei "意料之内，没有回应。\n我皱了皱眉，虽然不能跑步，但我还是尽量加快了脚下的速度，跟着她离开的方向走。"
    mei "不过，这个方向……总感觉，有点熟悉……"

    mei_speaking "啊——累死了……你可把我害惨了……"
    mei "我大喘一口气，无奈地嘟囔着，看向草丛里明显不久前才被人踩过的痕迹。\n这个地方通往北边的后山，因为土壤不适合种果树，现在也没有合适的植物成熟，平时很少会有人来这里。"
