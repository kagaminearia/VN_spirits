label chap10_p1:
    ...
    mei_speaking "……啊？"
    mei "不对，她这是什么意思……"
    peng_speaking "我向你表白是我自己的事，你不用有任何负担的。{nw=0.7}"
    peng_speaking "我不需要回应什么的，或者任何东西，只是……只是想告诉你，你真的是个很好的人，而已。{nw=0.7}"
    peng_speaking "其实……只要还能跟你产生联系我就满足了，我是这么想的。{nw=0.7}"
    peng_speaking "但是，见到你之后，又忍不住想要更加接近你。明知道我根本不应该……{nw=0.7}"
    peng_speaking "如果你没有追过来找我……或者，如果你一开始没有直说，我应该，一辈子也不会告诉你。{nw=0.7}"
    peng_speaking "我本来真的不想说的，我不想让你为难，所以准备永远瞒着你的。{nw=0.7}"
    peng_speaking "结果都怪我不小心，让你听到那些话，现在还得意忘形，直接跟你说。{nw=0.7}"
    peng_speaking "但是现在让你知道……我也不后悔，因为你真的很好。{nw=0.7}"
    peng_speaking "不过我也知道，这都是我自己的事，就算我说了你也不用在意的。{nw=0.7}"
    peng_speaking "我知道你肯定觉得麻烦了，但是你不用做任何事，之后也{nw=0.7}"
    hide meiimg
