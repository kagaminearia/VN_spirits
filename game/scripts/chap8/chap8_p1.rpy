label chap8_p1:
    ...
    mei "我用力捏了捏眉心，后知后觉地感觉到不对。刚才走神太久，我慌忙回神，却只看到彭江丽怔怔地盯着我的笔记本看。"
    mei_speaking "……彭江丽？"
    ...
    peng_speaking "……"
    peng_speaking "是我错了，我不该让你想起这些的。"
    peng_speaking "我，我不应该……不应该这么麻烦你。"
    mei_speaking "啊，不……"
    peng_speaking "可是，我还是想问……对不起，梅雨不想重新考试的话，之后有什么打算呢？"
    mei_speaking "……"
    ...
    mei_speaking "像你一样，可以很坚定地……"
    peng_speaking "……我一点也不坚定。"
    peng_speaking "但，但是，我跟你一起的话，一定可以的！"
    mei_speaking "……哎？"
    ...
    mei_speaking "嗯……"
    mei "她都这么说了，我只好点头。只是，我对自己还是没什么信心……这样真的可以吗，我真的还可以面对吗……"
    mei "但，如果真的可以，说不定……"
    mei_speaking "谢谢你。"
