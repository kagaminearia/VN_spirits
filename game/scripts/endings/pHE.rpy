label pHE:
    ...
    mei "某些细节在脑中一闪而过，被我抓住。"
    mei "这个月月底，村里每年最重要的节日，祝灵节。"
    mei "一整天，都有不同的活动，凭兴趣参加，气氛很足。不过现在这个时间……只剩最后的祝福仪式了。"
    ...
    mei_speaking "等等……诶，这样好吗？"
    peng_speaking "没事啦，之后收拾干净就好了。这些燃料是特制的，本来今天就是让大家在这里许愿的，平时也不会这么浪费材料。"
    mei_speaking "这样啊……那你要许愿吗？"
    ...
    mei_speaking "哦，是这样啊……"
    peng_speaking "而且……愿望你也知道，嗯，我昨天晚上说过的……"
    mei_speaking "……咳咳咳。"
    mei "她是突然开窍了吗？怎么变得这么直接……不过，让她这样的好像是我自己……"
    peng_speaking "你觉得会灵验吗？"
