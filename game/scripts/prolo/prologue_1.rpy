...
label prologue_1:
    ...
    peng_speaking "那就好……啊。{p}就是，我想跟你说个事情。噢，不是什么重要的事，你别这么看我啊。"
    hide meiimg
    ...
    mei "不对，不行。{p}不能紧张，绝对不能紧张……{p}想点别的，想点别的，控制呼吸……"
    peng_speaking "其实我……"
    mei "……快啊！！\n想点别的！！\n别再紧张了！！"
    hide pengimg
    ...
    ye_speaking "嗨，放轻松点，我和彭江丽又不会吃了你，没什么大不了的。{p}我也不打扰你了，要是有事用楼下电话打给我就行。"
    hide yeimg with moveoutright

    scene bg_meiroom with fade
    mei "直到关门的声音彻底消失，我才抬起头，怔怔地看着陌生的房间。{p}明亮的日光透过没遮盖严实的窗帘渗入屋内，却完全没有让我变暖。"
    mei "现在是早上七点，也就是说，我完全搞砸了昨天的晚饭，自顾自地突然晕倒，然后睡到现在。{p}而且，又是因为……"
    mei "……{p}此时此刻，我麻木到极致，竟然开始庆幸，至少现在不用直接面对彭江丽——当然，这应该也是，我唯一还能庆幸的事情吧。"
    mei "太糟糕了。"
    mei "绝对是，最糟糕的重逢……"
