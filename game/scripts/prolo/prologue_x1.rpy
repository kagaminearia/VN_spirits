label prologue_x1:
    ...
    mei "早就过了中午，阳光却依然不显颓势，热烈地展现自己的存在感。\n我缓慢地在砂石路上踱步，没碰到几个人，也没人在意我，实在令人安心许多。"
    mei "说不定，叶成华的方法真的有效，她硬是把我拉回这个地方……我不由得再次展开幻想。\n……明知道不切实际。"

    mei_speaking "……嗯？"
    mei "竟然走回这里了……大概是下意识顺着熟悉的路。就在上午，我才和叶成华在这里下车。"
    mei "被生锈的栏杆歪歪斜斜地围住，车站门口褪色的“欢迎光临”也显得并不那么欢迎。比起这个年代久远的招牌，边缘的一抹亮色更加吸引我的视线。"
    mei "波浪卷头发，繁复的裙褶边，少见的长筒袜，足有半人高的巨大行李箱……从上而下，她显得比我更加格格不入。\n即使在我上学的时候，也很少见到这样的打扮，更不要说在这样偏僻的地方。"
    ...
    mei "好累……结束莫名其妙的对话后，我开始感到疲乏。不知道是说话太累还是走路太累了，也许今天不适合出门，还是先回去吧。"
    mei "只是，我的预感也许真的只有在这种时候格外准确。"
    unknown_speaking "梅雨……吗？！你，你是……？"
    mei_speaking "……啊。"
    mei_speaking "那个，好久不见……。\n了（小声）……彭江丽。"
    peng_speaking "嗯，好久不见啊。"
    mei "我们能说的，好像只剩下这些——仅限礼貌的打招呼。\n也许是因为是意外遇到，连提前的准备都没有，就变成了这样。当然，也是最真实的模样……"
    mei_speaking "……"
    peng_speaking "……"
    peng_speaking "……对了，成华姐之前说你下午在家。你现在出来身体还好吗？会不会——"
    mei_speaking "我没事的。"
    mei "糟糕，又提前打断了……都怪之前那个人……不，是我自己太过敏感吧。"
